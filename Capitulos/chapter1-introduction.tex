...
\epigraph{Comprendí que el trabajo del poeta no
	estaba en la poesía; estaba en la invención de razones para que la poesía fuera
	admirable.}{\textit{El Aleph}, \\ Jorge Luis Borges}
...
El concepto de juego estocástico se contrapone al de juego tradicional de 2
jugadores. Mientras que en el último cada acción de un jugador resulta en un
único próximo estado del juego, en el primero cada acción de un jugador
determina una distribución de probabilidad sobre los posibles próximos estados
del juego. Es por esto que los juegos estocásticos han resultado una
herramienta útil para modelar sistemas en diversas áreas como finanzas,
...
cómo se define el hecho de que un jugador gane. En juegos estocásticos, una
manera de definir esto es a través de \textit{objetivos} dados en forma de una
\textit{propiedad $\omega$-regular} $\phi$. Como nos concentraremos en juegos
de suma cero, un jugador gana si se cumple $\phi$, mientras que su contrincante
ganará si se cumple $\neg \phi$.

Dentro de las propiedades $\omega$-regulares se destacan \textit{las
	condiciones de Rabin} y su dual, \textit{las condiciones de Streett}. La
...
determinación de los estados ganadores de un juego se lo suele llamar el
...
Gracias al uso que tuvieron los juegos estocásticos en el modelado de sistemas
en distintas áreas (en el campo de la seguridad informática~\cite{SGSecurity},
la robótica~\cite{SGInteractive}, las telecomunicaciones~\cite{SGM2M} y la
gestión de recursos~\cite{SGSmartGrid}, entre otros) resultó lógico dividir los
mismos en base a distintos tipos de funciones de pago. El estudio de la
existencia, tipo y computabilidad de las estrategias óptimas suele considerarse
en juegos con funciones de recompensa cuantitativas (eg., funciones de
recompensa media, con descuento, pesada o límite) y cualitativas (eg.,
funciones de recompensas asociadas a objetivos de alcanzabilidad, de Büchi, de
Rabin o de Müller) \cite{Chatterjee2007,Kučera2011,Chatterjee1}.

Las primeras propuestas de resultados para juegos estocásticos con funciones de
recompensa media y con descuento fueron reportadas desde 1958 por Gillete
\cite{Gillette1958}, mientras que los primeros resultados para juegos con
objetivos de alcanzabilidad fueron publicados por Condon en 1992
\cite{CONDON1992} y los juegos con objetivos de Rabin comenzaron a ser
estudidados en profundidad por Chaterjee desde 2005
\cite{ComplexityRabin,Chatterjee2007,Chatterjee1}.
...
politópicos con objetivos de alcanzabilidad, funciones de pago con descuento y
...
\begin{itemize}
	...
	\item En el \textbf{Capítulo~\ref{cap:psg}}, veremos definiciones formales referidas
	      a los juegos estocásticos politópicos y los resultados obtenidos en
	      \cite{Polytopal}.
	...
	\item En el \textbf{Capítulo~\ref{cap:results}}, desarrollaremos los resultados
	      ...
	      para juegos estocásticos politópicos y mostrando cómo calcular el conjunto de
	      estados ganadores con probabilidad 1 para el jugador maximizador en un juego
	      estocástico politópico con objetivo de Rabin.
