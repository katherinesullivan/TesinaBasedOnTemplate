...
de los MDPs) acompañados de unos teoremas que pueden resultar de utilidad. En
segundo lugar, introduciremos los juegos deterministas de adversario justo
para, finalmente, llegar a nuestro resultado principal que establece que la
región ganadora para el jugador maximizador en un juego estocástico politópico
con objetivo de Rabin es igual a la región ganadora para el jugador maximizador
en un juego determinista de adversario justo particular, que construiremos y
