...
\vspace{-1cm}
\epigraph{Perfección, completitud, belleza, ¡no son más que una excepción rara que sólo se presenta porque la cantidad de fragmentos es inimaginable!}{\textit{La investigación}, \\ Stanislaw Lem}
...
\begin{enumerate}
	...
	\item Establecimos una correspondencia entre caminos abstractos en el PSG y caminos
	      en su desrandomización, lo que nos permitió construir estrategias en cada uno
	      de ellos a partir de estrategias en el otro, y demostrar que un estado $s$ es
	      ganador en el PSG con alguna estrategia de memoria finita si y sólo si es
	      ganador en el juego justo correspondiente.
	\item A partir de esta equivalencia, se derivan dos consecuencias fundamentales:
	      \begin{itemize}
		      ...
		      \item Aprovechando los algoritmos existentes para juegos justos con objetivos de
		            ...
		            obtenemos un procedimiento efectivo para el cálculo de estados ganadores para
		            el PSG, con complejidad $O((n\,l)^2\,d!)$, donde $n$ es el número de estados en
		            el PSG, $l$ el máximo tamaño de soporte de las acciones, y $d$ el número de
		            pares Rabin.
	      \end{itemize}
\end{enumerate}
...
estándares para juegos de dos jugadores no-estocásticos.
...
estrategias extremas, aleatorias y sin memoria. Si pensamos en estrategias
