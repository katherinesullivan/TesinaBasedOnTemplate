...
\cite{Polytopal}. Si bien \cite{Polytopal} aborda 4 tipos distintos de objetivos (a saber, de
alcanzabilidad, de recompensa media, de recompensa total acumulada y de
recompensa total descontada), solo nos concentraremos en los resultados correspondientes a objetivos de alcanzabilidad.
...
que nos interesa y denotando como $\val_{\Gk,s}(\alc G)$ al valor del estado $s$
