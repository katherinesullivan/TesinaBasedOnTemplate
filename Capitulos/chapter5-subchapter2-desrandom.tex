...
\begin{proof}
	...
	comporta de acuerdo al orden de caminos presentado en la subsección anterior de esta sección \ref{ordenCaminos}.
	...
	Denotamos como $\Inf(\rho)_D$ a la función que le asocia a cada $s_i$ en
	...
	el PMDP $\M^*$, entonces vale la ecuación~\ref{varphi}.%esto que presentamos anteriormente quiere decir que 
