...
\newtcolorbox[auto counter, number within=section]{boxgris}[2][]{%
  colback=white,   % Color de fondo
  colbacktitle=gray, % Color de fondo del título
  coltitle=black,  % Color del título
  title=#1,        % Título del box
  width=\textwidth-1.5em, % Ancho del box
  before=\vspace{0.25cm}, % Espacio vertical antes del box
...
\newcommand{\kathy}[1]{\todo[color=pink!50]{KES: #1}}
\newcommand{\pedro}[1]{\todo[color=cyan!50]{PRD: #1}}
...
% Comandos cap obj//verif modelos
\newcommand{\Paths}{\textsf{Paths}} %% ver que hay paths en minuscula
\newcommand{\Pathsfin}{\textsf{Paths}_\textsf{fin}}
\newcommand{\prefijo}{\textsf{pref}}
\newcommand{\Cyl}{\textsf{Cyl}}

% Comandos cap objetivos
\newcommand{\Inf}{\textsf{Inf}}
\newcommand{\Buchi}{\textsf{Büchi}}
\newcommand{\coBuchi}{\textsf{co-Büchi}}
\newcommand{\Reach}{\textsf{Reach}}
\newcommand{\Safe}{\textsf{Safe}}
\newcommand{\Rabin}{\textsf{Rabin}}
\newcommand{\Streett}{\textsf{Streett}}
\newcommand{\Parity}{\textsf{Parity}}
\newcommand{\Muller}{\textsf{Müller}}
...
% Comandos PMDP
\newcommand{\EC}{\textsf{EC}}
\newcommand{\sub}{\textsf{sub}}
\newcommand{\er}{\textsf{er}}
\newcommand{\inft}{\textsf{inf}_\textsf{er}}
...
\newcommand{\polys}{\boldsymbol{K}}
\newcommand{\meass}{\boldsymbol{M}}


\newcommand{\last}{\textit{last}}

\newcommand{\GamePaths}{{\mathsf{Paths}^\omega}}
...
\newcommand{\VGk}{\mathcal{V}_{\Gk}}
\newcommand{\Vsi}{\mathcal{V}_{s_i}}
\newcommand{\Vs}{\mathcal{V}_s}

\newcommand{\camabs}{\mathsf{AbsPath}}
